...
4. Implement endpoints:
   ...
   - photo_url can be empty string initially (user uploads separately)
   ...
   - Update after_hours_profiles.photo_url with R2 key
...
Exports createAfterHoursRouter function
  ...
  <done>
Router file created with POST/GET/PATCH /profile and POST /profile/photo endpoints, all protected by After Hours auth middleware
  </done>
</task>
