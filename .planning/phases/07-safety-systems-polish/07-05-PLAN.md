...
must_haves:
  truths:
    - "Session start logs after_hours_session_started event"
    - "Match received logs after_hours_match_received event"
    - "Chat opened logs after_hours_chat_started event"
    - "Mutual save logs after_hours_match_saved event"
  artifacts:
