...
must_haves:
  truths:
    - "System can detect repeated ban evaders via device fingerprinting"
    - "Banned photos cannot be reused with different accounts"
    - "Photo upload is rejected with 403 if hash matches banned content"
  artifacts:
